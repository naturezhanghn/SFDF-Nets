...
# Parameters
    ...
    parser.add_argument("--dataset_name", type=str, default="spiderdata_p5e-2_o600", help="name of the dataset")
    ...
    parser.add_argument("--step_size", type=int, default=100, help="epoch from which to start lr decay")
