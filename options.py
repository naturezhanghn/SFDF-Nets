...
# Parameters
    ...
    parser.add_argument("--dataset_name", type=str, default="spiderdata_p5e-2_o60", help="name of the dataset")
    ...
    parser.add_argument("--load_best", type=bool, default=False, help="load the best generator weights")
    ...
    # parser.add_argument("--lr_decay_epoch", type=int, default=200, help="epoch from which to start lr decay")
    
    parser.add_argument("--GAN_lambda", type=float, default=1e-6, help="GAN loss proportion")#0.0002
    parser.add_argument("--Per_lambda", type=float, default=1e-4, help="Per loss proportion")#0.0002
